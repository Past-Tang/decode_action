//Fri Apr 17 2026 05:20:27 GMT+0000 (Coordinated Universal Time)
...
var initSqlJs = function (moduleConfig) {
  ...
  initSqlJsPromise = new Promise(function (resolveModule, reject) {
    ...
    var aa = "object" == typeof window,
      ...
      ca = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node && "renderer" != process.type;
    "use strict";
    f.onRuntimeInitialized = function () {
      function a(g, l) {
        switch (typeof l) {
          ...
          case "string":
            ...
            break;
          case "object":
            if (null === l) lb(g);else if (null != l.length) {
              var n = da(l, ea);
              gc(g, n, l.length, -1);
              fa(n);
      ...
      function b(g, l) {
        for (var n = [], r = 0; r < g; r += 1) {
          var t = m(l + 4 * r, "i32"),
            y = hc(t);
          if (1 === y || 2 === y) t = ic(t);else if (3 === y) t = jc(t);else if (4 === y) {
            y = t;
            t = kc(y);
            y = lc(y);
      ...
      var h = z(4),
        ...
        tb = k("sqlite3_create_function_v2", "number", "number string number number number number number number number".split(" ")),
      ...
      c.prototype.freemem = function () {
        for (var g; undefined !== (g = this.lb.pop());) fa(g);
      };
      ...
      e.prototype.each = function (g, l, n, r, t) {
        "function" === typeof l && (r = n, n = l, l = undefined);
        g = this.prepare(g, l);
        try {
    ...
    async function Va(a) {
      ...
      if (a == Ua && Ja) a = new Uint8Array(Ja);else if (Fa) a = Fa(a);else throw "both async and sync fetching of the wasm failed";
      return a;
    }
    ...
    var db = "undefined" != typeof TextDecoder ? new TextDecoder() : undefined,
      B = (a, b = 0, c = NaN) => {
        var d = b + c;
        for (c = b; a[c] && !(c >= d);) ++c;
    ...
    var xb = {
        ...
        read(a, b, c, d) {
          ...
          for (var e = 0, h = 0; h < d; h++) {
            ...
            if (undefined === k && 0 === e) throw new N(6);
            if (null === k || undefined === k) break;
            e++;
            b[c + h] = k;
          }
            ...
            if (!kb.length) {
              ...
              if (ca) {
                ...
                try {
                  ...
                  if (e.toString().includes("EOF")) c = 0;else throw e;
                }
      ...
      O = {
        ...
        La: {
          ...
          Ua(a, b) {
            ...
            undefined !== b.size && (b = b.size, a.Ra != b && (0 == b ? (a.Na = null, a.Ra = 0) : (c = a.Na, a.Na = new Uint8Array(b), c && a.Na.set(c.subarray(0, Math.min(b, a.Ra))), a.Ra = b)));
          },
          lookup() {
            throw O.vb;
          },
        ...
        Ma: {
          read(a, b, c, d, e) {
            ...
            if (8 < a && h.subarray) b.set(h.subarray(e, e + a), c);else for (d = 0; d < a; d++) b[c + d] = h[e + d];
            return a;
          },
          write(a, b, c, d, e, h) {
            ...
            if (a.Na.subarray && b.subarray) a.Na.set(b.subarray(c, c + d), e);else for (h = 0; h < d; h++) a.Na[e + h] = b[c + h];
    ...
    function S(a, b = {}) {
      ...
      a: for (; 40 > c; c++) {
        ...
        for (var d = Eb, e = "/", h = 0; h < a.length; h++) {
          var k = h === a.length - 1;
          if (k && b.parent) break;
          if ("." !== a[h]) if (".." === a[h]) e = fb(e), d = d.parent;else {
            e = ka(e + "/" + a[h]);
            try {
              d = Q(d, a[h]);
            } catch (q) {
    ...
    function Cb(a) {
      ...
      if (R[b] === a) R[b] = a.bb;else for (b = R[b]; b;) {
        if (b.bb === a) {
          b.bb = a.bb;
          break;
        }
    ...
    function Ec(a, b, c, d, e) {
      ...
      if (!h) e = a.position;else if (!a.seekable) throw new N(70);
      ...
      wb(e, {
        ...
        read(h, k, q, w) {
          for (var v = 0, C = 0; C < w; C++) {
            ...
            if (undefined === G && 0 === v) throw new N(6);
            if (null === G || undefined === G) break;
            v++;
            k[q + C] = G;
          }
      ...
      Sc = () => {
        if (!Rc) {
          var a = {
            ...
            b;
          for (b in Qc) undefined === Qc[b] ? delete a[b] : a[b] = Qc[b];
          var c = [];
    ...
    var Xc = {
        a: (a, b, c, d) => Ta(`Assertion failed: ${a ? B(x, a) : ""}, at: ` + [b ? b ? B(x, b) : "" : "unknown filename", c, d ? d ? B(x, d) : "" : "unknown function"]),
        i: function (a, b) {
          try {
